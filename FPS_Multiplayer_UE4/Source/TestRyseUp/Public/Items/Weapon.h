...
class TESTRYSEUP_API AWeapon : public AActor
{
	GENERATED_BODY()
...
protected:
	...
	class ATestRyseUpCharacter* MyPawn;
...
public:	
	...
	void SetOwningPawn(ATestRyseUpCharacter* NewOwner);

	/* Get pawn owner */
	UFUNCTION(BlueprintCallable, Category = "Weapon")
	class ATestRyseUpCharacter* GetPawnOwner() const;

	virtual void OnEnterInventory(ATestRyseUpCharacter* NewOwner);

	virtual void OnLeaveInventory();

	FORCEINLINE int GetStorageSlot()
	{
		return StorageSlot;
	}
...
public:
	...
	void AttachMeshToPawn(int Slot = 0);
